...
class TabContainer : GridPane() {
        ...
        VBox().apply {
            ...
            children.add(
                Label(labelText).apply {
                    style =
                        "-fx-text-fill: ${ColorPalette.textColor}; -fx-font-family: '${ResourceHandler.comfortaaBold.family}'; -fx-font-size: 14;"
                    setMaxSize(145.0, 35.0)
                    setMinSize(145.0, 35.0)
    ...
    private fun implementInfoBox() {
        ...
        add(createLabel("1.0.0", Pos.BOTTOM_CENTER, 15.0, ColorPalette.controlColor), 0, 2)
    }
}
