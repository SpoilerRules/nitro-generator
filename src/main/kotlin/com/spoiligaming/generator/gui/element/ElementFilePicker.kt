...
object ElementFilePicker {
    fun addTextValue(
        ...
        val selectedFileLabel =
            Label().apply {
                style =
                    "-fx-text-fill: ${ColorPalette.textColor}; -fx-font-family: '${ResourceHandler.comfortaaBold.family}'; -fx-font-size: 13;"
                text =
                    if (BaseConfigurationFactory.getInstance().proxySettings.proxyFilePath.isEmpty()) {
                        "No proxy file is selected."
                    } else {
                        "Selected proxy file: ${
        ...
        return VBox().apply {
            ...
            children.addAll(
                HBox().apply {
                    spacing = 5.0
                    children.add(
                        Button("Select proxy file").apply {
                            alignment = Pos.CENTER
                            setMaxSize(142.0, 25.0)
                            setMinSize(142.0, 25.0)
                            style =
                                "-fx-background-color: ${ColorPalette.controlColor}; -fx-text-fill: ${ColorPalette.textColor}; -fx-font-family: '${ResourceHandler.comfortaaSemiBold.family}'; -fx-font-size: 14; -fx-background-radius: 12; -fx-highlight-fill: ${ColorPalette.accentColor}; -fx-padding: 0;"
                            setOnAction {
                                FileChooser().apply {
