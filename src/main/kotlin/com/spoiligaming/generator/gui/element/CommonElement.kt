...
class CommonElement {
    ...
    fun createContentField(gridPane: GridPane, contentFieldTitle: String, contentFieldHeight: Double, vararg content: Node) {
        gridPane.apply {
            add(VBox().apply {
    ...
    companion object {
        fun createLabel(text: String) = Label(text).apply {
            ...
            style =
                "-fx-background-color: transparent; -fx-text-fill: ${ColorPalette.TEXT_COLOR}; -fx-font-family: '${ResourceHandler.comfortaaSemiBold.family}'; -fx-font-size: 13;"
        }
    }
}